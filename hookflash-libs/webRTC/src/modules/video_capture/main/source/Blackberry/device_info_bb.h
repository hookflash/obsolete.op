...
#ifndef WEBRTC_MODULES_VIDEO_CAPTURE_MAIN_SOURCE_BLACKBERRY_DEVICE_INFO_BB_H_
#define WEBRTC_MODULES_VIDEO_CAPTURE_MAIN_SOURCE_BLACKBERRY_DEVICE_INFO_BB_H_
...
#endif // WEBRTC_MODULES_VIDEO_CAPTURE_MAIN_SOURCE_BLACKBERRY_DEVICE_INFO_BB_H_
