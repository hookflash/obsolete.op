...
#ifndef WEBRTC_AUDIO_DEVICE_AUDIO_MIXER_MANAGER_BB_H
#define WEBRTC_AUDIO_DEVICE_AUDIO_MIXER_MANAGER_BB_H
...
public:
    AudioMixerManagerBB(const WebRtc_Word32 id);
    ~AudioMixerManagerBB();
...
#endif  // WEBRTC_AUDIO_DEVICE_AUDIO_MIXER_MANAGER_BB_H
