...
enum VideoRotationMode
{
...
#ifdef MAC_IPHONE
    WebRtc_Word32 ConvertI420ToABGR_LIBYUV(const WebRtc_UWord8* inFrame, WebRtc_UWord8* outFrame,
                                           WebRtc_UWord32 width, WebRtc_Word32 height,
                                           WebRtc_UWord32 strideOut);
    WebRtc_Word32 ConvertABGRToI420_LIBYUV(WebRtc_UWord32 width, WebRtc_Word32 height,
                                           const WebRtc_UWord8* inFrame, WebRtc_UWord8* outFrame);
    WebRtc_Word32 ScaleRGBAFrameDouble_LIBYUV(WebRtc_UWord32 width, WebRtc_UWord32 height,
                                              WebRtc_UWord8* inFrame);
    WebRtc_Word32 ConvertNV12ToI420AndScaleFrameDouble_LIBYUV(WebRtc_UWord32 width, WebRtc_UWord32 height,
                                                              WebRtc_UWord8* inFrame);
    ...
    WebRtc_Word32 ConvertRGB565ToI420(const WebRtc_UWord8* inFrame, WebRtc_UWord32 width,
                                      WebRtc_UWord32 height, WebRtc_UWord8* outFrame);
    WebRtc_Word32 ConvertABGRMacToI420(WebRtc_UWord32 width, WebRtc_UWord32 height,
                                    const WebRtc_UWord8* inFrame, WebRtc_UWord8* outFrame);
