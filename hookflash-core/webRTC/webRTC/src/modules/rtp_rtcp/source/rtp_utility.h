...
namespace ModuleRTPUtility
{
    ...
    public:
        ...
        bool Parse(RTPPayload& parsedPacket, bool markerBit) const;
    ...
    private:
        ...
        bool ParseVP8_old(RTPPayload& parsedPacket) const;
      
        bool ParseVP8(RTPPayload& parsedPacket, bool markerBit) const;
