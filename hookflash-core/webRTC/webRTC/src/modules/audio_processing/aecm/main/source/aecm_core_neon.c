 ...
 */
#if (defined(MAC_IPHONE) || defined(WEBRTC_ANDROID)) && defined(WEBRTC_ARCH_ARM_NEON)
...
#endif // #if (defined(MAC_IPHONE) || defined(WEBRTC_ANDROID)) && defined(WEBRTC_ARCH_ARM_NEON)
