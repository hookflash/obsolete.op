...
#ifndef WEBRTC_MODULES_VIDEO_CAPTURE_MAIN_SOURCE_IPHONE_VIDEO_CAPTURE_MAC_H_
#define WEBRTC_MODULES_VIDEO_CAPTURE_MAIN_SOURCE_IPHONE_VIDEO_CAPTURE_MAC_H_
...
class VideoCaptureIPhoneInfo: public DeviceInfoImpl
{
public:
    // public methods
    ...
    VideoCaptureIPhoneInfo(const WebRtc_Word32 id);
    virtual ~VideoCaptureIPhoneInfo();
...
#endif // WEBRTC_MODULES_VIDEO_CAPTURE_MAIN_SOURCE_IPHONE_VIDEO_CAPTURE_MAC_H_
