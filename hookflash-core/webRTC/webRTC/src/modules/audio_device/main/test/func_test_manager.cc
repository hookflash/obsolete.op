...
#else
const WebRtc_Word8 PlayoutFile48[] = "/Documents/audio_short48.pcm";
const WebRtc_Word8 PlayoutFile44[] = "/Documents/audio_short44.pcm";
const WebRtc_Word8 PlayoutFile16[] = "/Documents/audio_short16.pcm";
const WebRtc_Word8 PlayoutFile8[] = "/Documents/audio_short8.pcm";
const WebRtc_Word8 RecordedMicrophoneFile[] = "/Documents/recorded_microphone_mono_44.pcm";
const WebRtc_Word8 RecordedMicrophoneVolumeFile[] =
"/Documents/recorded_microphone_volume_mono_44.pcm";
const WebRtc_Word8 RecordedMicrophoneMuteFile[] =
"/Documents/recorded_microphone_mute_mono_44.pcm";
const WebRtc_Word8 RecordedMicrophoneBoostFile[] =
"/Documents/recorded_microphone_boost_mono_44.pcm";
const WebRtc_Word8 RecordedMicrophoneAGCFile[] =
"/Documents/recorded_microphone_AGC_mono_44.pcm";
const WebRtc_Word8 RecordedSpeakerFile[] = "/Documents/recorded_speaker_44.pcm";
#endif
...
char* GetResource(char* resource)
{
    char tmpResource[256];
    strcpy((char*)tmpResource, (const char*)resource);
    strcpy(resource, homeDirectory);
    strcat(resource, tmpResource);
    return resource;
}
const char* GetResource(const char* resource)
{
    char tmpResource[256];
    strcpy((char*)tmpResource, resource);
    strcpy((char*)resource, homeDirectory);
    strcat((char*)resource, tmpResource);
    return resource;
}
#endif
...
WebRtc_Word32 FuncTestManager::TestAudioTransport()
{
    ...
    if (playIsAvailable)
    {
        ...
        WebRtc_Word8 playoutFile[256];
        if (samplesPerSec == 48000)
        {
            strcpy((char*)playoutFile, PlayoutFile48);
            _audioTransport->SetFilePlayout(true, GetResource((char*)playoutFile));
        }
        else if (samplesPerSec == 44100 || samplesPerSec == 44000)
        {
            strcpy((char*)playoutFile, PlayoutFile44);
            _audioTransport->SetFilePlayout(true, GetResource((char*)playoutFile));
        }
        else if (samplesPerSec == 16000)
        {
            strcpy((char*)playoutFile, PlayoutFile16);
            _audioTransport->SetFilePlayout(true, GetResource((char*)playoutFile));
        }
        else if (samplesPerSec == 8000)
        {
            strcpy((char*)playoutFile, PlayoutFile8);
            _audioTransport->SetFilePlayout(true, GetResource((char*)playoutFile));
        }
        else
        {
    ...
    if (recIsAvailable)
    {
        ...
        WebRtc_Word8 recordFile[256];
        strcpy((char*)recordFile, RecordedMicrophoneFile);
        TEST(audioDevice->StartRawInputFileRecording(
            GetResource((char*)recordFile)) == 0);
        TEST(audioDevice->RegisterAudioCallback(_audioTransport) == 0);
