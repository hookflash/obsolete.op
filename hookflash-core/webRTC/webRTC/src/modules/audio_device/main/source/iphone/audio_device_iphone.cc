...
WebRtc_Word32 AudioDeviceIPhone::StopRecording()
{
    ...
    if (_recording && !_playing)
    {
        ...
        WEBRTC_CA_RETURN_ON_ERR(AudioSessionSetActive(false));
    }
