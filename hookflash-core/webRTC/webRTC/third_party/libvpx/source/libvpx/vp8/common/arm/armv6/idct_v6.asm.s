...
@                   r0  r1  r2  r3  r4  r5  r6  r7  r8  r9  r10 r11 r12     r14
    .globl _vp8_short_idct4x4llm_1_v6
	.globl vp8_short_idct4x4llm_1_v6
    .globl _vp8_short_idct4x4llm_v6
	.globl vp8_short_idct4x4llm_v6
    .globl _vp8_short_idct4x4llm_v6_scott
	.globl vp8_short_idct4x4llm_v6_scott
...
_vp8_short_idct4x4llm_1_v6:
	vp8_short_idct4x4llm_1_v6: @         @   cycles  in  out pit
            @
...
_vp8_short_idct4x4llm_v6:
	vp8_short_idct4x4llm_v6: @           @   cycles  in  out pit
            @
...
_vp8_short_idct4x4llm_v6_scott:
	vp8_short_idct4x4llm_v6_scott: @         @   cycles  in  out pit
@   mov r0, #0  @
@   ldr r0, [r0]    @
    stmdb   sp!, {r4 - r11, lr} @ backup registers  1                   backup
            @
...
_vp8_short_idct4x4llm_v6_dual:
	vp8_short_idct4x4llm_v6_dual: @          @   cycles  in  out pit
            @
    stmdb   sp!, {r4-r11, lr}   @ backup registers  1                   backup
    mov r3, #0x00004E00 @                   cos
    orr r3, r3, #0x0000007B @ cospi8sqrt2minus1
