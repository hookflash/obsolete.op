all: \
    $(SHARED_INTERMEDIATE_DIR)/third_party/libvpx/asm_enc_offsets.o \
    $(SHARED_INTERMEDIATE_DIR)/third_party/libvpx/vpx_config.o \
...
$(SHARED_INTERMEDIATE_DIR)/third_party/libvpx/asm_enc_offsets.o \
	...
	@echo note: "Build libvpx yasm build source/config/mac/ia32/asm_enc_offsets.asm."
	"$(BUILT_PRODUCTS_DIR)/yasm" -I source/config/mac/ia32 -I source/libvpx -fmacho32 -m x86 -o "$(SHARED_INTERMEDIATE_DIR)/third_party/libvpx/asm_enc_offsets.o" "source/config/mac/ia32/asm_enc_offsets.asm"
...
$(SHARED_INTERMEDIATE_DIR)/third_party/libvpx/vpx_config.o \
    ...
    $(BUILT_PRODUCTS_DIR)/yasm
	@mkdir -p "$(SHARED_INTERMEDIATE_DIR)/third_party/libvpx"
	@echo note: "Build libvpx yasm build source/config/mac/ia32/vpx_config.asm."
	"$(BUILT_PRODUCTS_DIR)/yasm" -I source/config/mac/ia32 -I source/libvpx -fmacho32 -m x86 -o "$(SHARED_INTERMEDIATE_DIR)/third_party/libvpx/vpx_config.o" "source/config/mac/ia32/vpx_config.asm"
...
$(SHARED_INTERMEDIATE_DIR)/third_party/libvpx/quantize_sse4.o \
    ...
    $(BUILT_PRODUCTS_DIR)/yasm
	@mkdir -p "$(SHARED_INTERMEDIATE_DIR)/third_party/libvpx"
	@echo note: "Build libvpx yasm build source/libvpx/vp8/encoder/x86/quantize_sse4.asm."
...
$(SHARED_INTERMEDIATE_DIR)/third_party/libvpx/variance_impl_ssse3.o \
    ...
    $(BUILT_PRODUCTS_DIR)/yasm
	@mkdir -p "$(SHARED_INTERMEDIATE_DIR)/third_party/libvpx"
	@echo note: "Build libvpx yasm build source/libvpx/vp8/encoder/x86/variance_impl_ssse3.asm."
...
$(SHARED_INTERMEDIATE_DIR)/third_party/libvpx/temporal_filter_apply_sse2.o \
	...
	"$(BUILT_PRODUCTS_DIR)/yasm" -I source/config/mac/ia32 -I source/libvpx -fmacho32 -m x86 -o "$(SHARED_INTERMEDIATE_DIR)/third_party/libvpx/temporal_filter_apply_sse2.o" "source/libvpx/vp8/encoder/x86/temporal_filter_apply_sse2.asm"
