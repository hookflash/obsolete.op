...
class AudioMixerManagerIPhone
{
public:
    WebRtc_Word32 OpenSpeaker();
    WebRtc_Word32 OpenMicrophone();
    ...
    WebRtc_Word32 SetLoudspeakerStatus(bool enable);
    WebRtc_Word32 GetLoudspeakerStatus(bool& enable) const;
    WebRtc_Word32 SetOutputAudioRoute(OutputAudioRoute route);
    WebRtc_Word32 GetOutputAudioRoute(OutputAudioRoute& route) const;
    WebRtc_Word32 Close();
...
public:
    AudioMixerManagerIPhone(const WebRtc_Word32 id);
    ~AudioMixerManagerIPhone();
...
#endif  // WEBRTC_AUDIO_DEVICE_AUDIO_MIXER_MANAGER_IPHONE_H
